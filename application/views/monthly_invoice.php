        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Monthly Invoice</li>
                </ol>
            </div><!--/.row-->
            ...
            <section class="content">
                ...
                <div class="row">
                    ...
                    <section class="col-lg-12 connectedSortable">
                        ...
                        ?>                               
                        <?php echo form_open_multipart('Invoice/search_monthly_invoice',array('class' => 'form-inline search-report')); ?>
                            <div class="form-group">
                                <input type="date" name="date" class="form-control" style="border-radius: 0px;" >
                            </div>
                                                            ...
                                                            <table class="table table-hover" data-toggle="table" data-url="tables/data2.json">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr data-index="0">
                                                                        ...
                                                                        <td style="">
                                                                            <center>
                                                                                <a title="Do Complete" href="change_monthly_invoice_status/<?php echo $value->id; ?>/COMPLETE"><svg class="glyph stroked checkmark" style="width: 30px;height: 30px;background-color: #bafff5;border-radius:50%;color: #00edff"><use xlink:href="#stroked-checkmark"/></svg></a>
                                                                                <a title="Do Cancel" href="change_monthly_invoice_status/<?php echo $value->id; ?>/CANCEL"><svg class="glyph stroked cancel" style="width: 30px;height: 30px;background-color: #F8769F;border-radius:50%;color: rgb(255, 0, 0)"><use xlink:href="#stroked-cancel"/></svg></a>                                                                
                                                                                <a title="Do Pending" href="change_monthly_invoice_status/<?php echo $value->id; ?>/PENDING/<?php echo $value->good; ?>"><svg class="glyph stroked hourglass" style="width: 30px;height: 30px;background-color: #bafff5;border-radius:50%;color: #bafff5"><use xlink:href="#stroked-hourglass"/></svg></a>
                                                                            </center>
                                                                        </td>
                                                                        <td style="">
                                                                            <a title="View" href="view_invoice_details/<?php echo $value->id; ?>"><center><svg class="glyph stroked arrow right" style="width: 30px;height: 30px;background-color: #bafff5;border-radius:50%;color: #00edff"><use xlink:href="#stroked-arrow-right"/></center></a>
